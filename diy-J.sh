...
cd $CURRENT_DIR/$DIR
#共存
sed -i 's/com.github.tvbox.osc/com.github.tvbox.coco/g' $CURRENT_DIR/$DIR/app/build.gradle
#签名
...
#名称修改
sed -i 's/TVBox/筱影視PTV/g' $CURRENT_DIR/$DIR/app/src/main/res/values/strings.xml
#图标修改
